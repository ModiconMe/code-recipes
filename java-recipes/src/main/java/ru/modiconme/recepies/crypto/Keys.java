...
public class Keys {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Certificate cert = FromPemFile.readX509CertFromPemJava(certPath);
        System.out.println(cert);

        var pubKeyPath = Path.of(Resources.getResource("certs/public.key").getPath());
        RSAPublicKey pubKey1 = FromPemFile.readX509PublicKeyJava(pubKeyPath);
        RSAPublicKey pubKey2 = FromPemFile.readX509PublicKeyBC(pubKeyPath);
        ...
        PrivateKey privateKey1 = FromPemFile.readPEMPrivateKeyJava(noEncPrivateKeyPath);
        PrivateKey privateKey2 = FromPemFile.readPEMPrivateKeyBC1(noEncPrivateKeyPath);
        PrivateKey privateKey3 = FromPemFile.readPEMPrivateKeyBC2(noEncPrivateKeyPath);
        ...
        KeyStore keyStore = KeyStoreUtils.loadPKCS12KeyStore(keyStorePath, KEYSTORE_PASSWORD);
        ...
        KeyStore.PrivateKeyEntry keyEntry = KeyStoreUtils.loadKeyAndCert(keyStore);
        System.out.println(certificate);
        System.out.println(privateKey);
        System.out.println(keyEntry.getPrivateKey());
        System.out.println(keyEntry.getCertificate());

        SecretKeySpec defaultSecretKey = KeyGeneration.getDefaultSecretKey();
        System.out.println(defaultSecretKey);
        SecretKeySpec secretKey = KeyGeneration.getSecretKey();
        System.out.println(secretKey);
        KeyPair keyPair = KeyGeneration.gen2048RsaKeyPair();
     ...
     */
    @UtilityClass
    public static class FromPemFile {

        @SneakyThrows
        public static PrivateKey readPEMPrivateKeyJava(Path privateKeyPath) {
         ...
         */
        @SneakyThrows
        public static RSAPrivateKey readPEMPrivateKeyBC1(Path privateKeyPath) {
         ...
         */
        @SneakyThrows
        public static RSAPrivateKey readPEMPrivateKeyBC2(Path privateKeyPath){
            try (var keyReader = newBufferedReader(privateKeyPath)) {
        ...
        @SneakyThrows
        public static Certificate readX509CertFromPemJava(Path path) {
        ...
        @SneakyThrows
        public static RSAPublicKey readX509PublicKeyJava(Path pubKeyPath) {
        ...
        @SneakyThrows
        public RSAPublicKey readX509PublicKeyBC(Path path) {
     ...
     */
    @UtilityClass
    public static class KeyStoreUtils {
         ...
         */
        @SneakyThrows
        public static KeyStore.PrivateKeyEntry loadKeyAndCert(KeyStore keyStore) {
        ...
        @SneakyThrows
        public static KeyStore loadPKCS12KeyStore(Path path, String keystorePassword) {
    ...
    public static class KeyGeneration {
         ...
         */
        public static KeyGenerator aesKeyGenerator() {
            return keyGenerator("AES");
        }

        public static KeyGenerator hmacSHA3512KeyGenerator() {
            return keyGenerator("HmacSHA3-512");
        }

        @SneakyThrows
        public static KeyGenerator keyGenerator(String algo) {
        ...
        @SneakyThrows
        public static KeyPair gen2048RsaKeyPair() {
        ...
        @SneakyThrows
        public static SecretKeySpec getDefaultSecretKey() {
            return getSecretKey("1234", "salt", 256, "PBKDF2WithHmacSHA256");
        }
